...
export function CreateTecnicoDialog({
  adminOrSecretariaId,
  isSmall = false,
  asCard = false,
}: {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px] bg-slate-200">
        <DialogHeader>
          ...
          <DialogDescription>
            Ingresa los datos del nuevo técnico. Quedará asignado bajo tu
            supervisión.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={onSubmit} className="space-y-4 pt-4">
          ...
          <p className="text-xs text-muted-foreground">
            Será usado como el identificador de ingreso del Técnico.
          </p>
          <div className="space-y-2">
