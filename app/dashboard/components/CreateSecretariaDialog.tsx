...
export function CreateSecretariaDialog({ adminId, asCard = false }: { adminId: string; asCard?: boolean }) {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Ingresa los datos de la nueva secretaria. Se registrará bajo tu administración.
                    </DialogDescription>
                </DialogHeader>
                <form onSubmit={onSubmit} className="space-y-4 pt-4">
                    <div className="space-y-2">
                        <Label htmlFor="nombres">Nombres</Label>
                        <Input id="nombres" name="nombres" placeholder="Ej. Ana María" required />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="apellidos">Apellidos</Label>
                        <Input id="apellidos" name="apellidos" placeholder="Ej. García López" required />
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="codigoUsuario">Código de Usuario / DNI</Label>
                        <Input id="codigoUsuario" name="codigoUsuario" placeholder="Ej. 12345678" required />
                    </div>
                    <p className="text-xs text-muted-foreground">Será usado como el identificador de ingreso de la Secretaria.</p>
                    <div className="space-y-2">
